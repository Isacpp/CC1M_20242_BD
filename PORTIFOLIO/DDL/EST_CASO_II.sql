...
AERON_PREFIXO VARCHAR(50) NOT NULL,
...
VOO_AERONAVE INT NOT NULL,
CONSTRAINT FK_AERONAVE FOREIGN KEY (VOO_AERONAVE) REFERENCES AERONAVE(AERON_ID)
);
...
CONSTRAINT FK_VOOSI FOREIGN KEY (VOO_ID) REFERENCES VOOS(VOO_ID)
);
...
CONSTRAINT FK_VOOSII FOREIGN KEY (VOO_ID) REFERENCES VOOS(VOO_ID),
